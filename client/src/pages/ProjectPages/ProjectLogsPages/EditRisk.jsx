        ...
        <div className="w-full py-10">
            <form onSubmit={handleRisk} className="flex w-[60%] mx-auto flex-col">
                <div className="flex w-full items-center mb-6">
                    ...
                    <Select
                        defaultValue={singleRiskData.risk_category}
                        ref={riskCategoryRef}
                        className='w-[70%] '
                ...
                <div className="flex w-full items-center mb-6">
                    ...
                    <input defaultValue={singleRiskData.risk_name} placeholder="Enter risk name" name="riskName" id="riskName" className="border-primary border w-[70%] p-3 rounded outline-none " type="text" />
                ...
                <div className="flex w-full items-center mb-6">
                    ...
                    <textarea defaultValue={singleRiskData.risk_description} className="border-primary border w-[70%] p-3 rounded outline-none" name="riskDescription" id="riskDescription" cols="10" rows="4" placeholder="Write risk description"></textarea>
                </div>
                <div className="flex w-full items-center mb-6">
                    <div className="w-[30%]  flex items-center gap-2">
                    ...
                    <textarea defaultValue={singleRiskData.risk_cause} className="border-primary border w-[70%] p-3 rounded outline-none" name="riskCause" id="riskCause" cols="10" rows="4" placeholder="Write risk cause"></textarea>
                </div>
                <div className="flex w-full items-center mb-6">
                    <label className="w-[30%]" htmlFor="">Risk Owner</label>
                    <Select
                        ref={riskOwnerRef}
                        defaultValue={singleRiskData.risk_owner}
                        className='w-[70%] z-[50]'
                ...
                <div className="flex w-full items-center mb-6">
                    ...
                    <input defaultValue={singleRiskData.risk_effect} placeholder="Enter control name" name="riskEffect" id="riskEffect" className="border-primary border w-[70%] p-3 rounded outline-none" type="text" />
                </div>
                <div className="flex w-full items-center mb-6">
                    ...
                    <div className='flex w-[70%] gap-4 items-center '>
                        <Select
                            ref={consequencesRef}
                            defaultValue={singleRiskData.consequences}
                            className={`w-[70%] z-[40]`}
                        ...
                        <Select
                            ...
                            defaultValue={singleRiskData.risk_consequences_impact}
                            className={`w-[70%] z-[40]`}
                ...
                <div className="flex w-full items-center mb-6">
                    ...
                    <div className='w-[70%]'>
                        <div className='flex  gap-4'>
                            <Select
                                ref={likelihoodRef}
                                defaultValue={singleRiskData.likelihood}
                                className='w-[70%] '
                            ...
                            <Select
                                ref={rattingRef}
                                defaultValue={singleRiskData.ratting}
                                className='w-[70%] '
