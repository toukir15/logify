            ...
            {!checkViewControl && <div>
                ...
                <div className="flex w-full">
                    ...
                    <div className="flex gap-4 items-center w-1/4 justify-end">
                        {controlAddRiskStatus == "risk" && <Link to={`/projects/logs/${controlAddRiskStatus}/${openClosedStatus}/add-risk/456465`}><button className="border-primary bg-primary border text-white py-2 px-4  rounded-lg">Add Risk</button></Link>}
                        {controlAddRiskStatus == "control" && <Link to={`/projects/logs/${controlAddRiskStatus}/${openClosedStatus}/add-control/456465`}><button className="border-primary bg-primary border text-white py-2 px-4  rounded-lg">Add Control</button></Link>}
                        <Link to={`/projects/logs/${controlAddRiskStatus}/${openClosedStatus}/filter/45654`}>
